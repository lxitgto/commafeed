...
RUN apt-get install -y python-software-properties && add-apt-repository ppa:openjdk-r/ppa && apt-get update && apt-get install -y git vim g++ build-essential openjdk-8-jdk maven \
